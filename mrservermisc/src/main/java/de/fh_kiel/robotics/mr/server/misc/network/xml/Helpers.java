package de.fh_kiel.robotics.mr.server.misc.network.xml;
...
public class Helpers {
	...
	public static void createNetworkHandschakeSchema( ){
		...
		createXMLSchema( "networkhandshakeschema.xsd",
				de.fh_kiel.robotics.mr.server.misc.network.handshake.server.ConnectionAcknowlege.class,
				de.fh_kiel.robotics.mr.server.misc.network.handshake.server.ConnectionRequest.class,
				de.fh_kiel.robotics.mr.server.misc.network.handshake.server.ConnectionEstablished.class  );
	...
	public static void createPositionDataPacketSchema( ){
		...
		createXMLSchema( "positiondatapacketschema.xsd",
				de.fh_kiel.robotics.mr.server.misc.network.data.position.PositionDataPackage.class, 
				de.fh_kiel.robotics.mr.server.misc.network.data.position.PositionObject.class,
				de.fh_kiel.robotics.mr.server.misc.network.data.position.PositionObjectBot.class, 
				de.fh_kiel.robotics.mr.server.misc.network.data.position.PositionObjectRectangle.class  );
	...
	public static void createChangeVisionModeSchema( ){
		...
		createXMLSchema( "changevisionmodeschema.xsd",
				de.fh_kiel.robotics.mr.server.misc.network.data.visionmode.ChangeVisionMode.class  );
