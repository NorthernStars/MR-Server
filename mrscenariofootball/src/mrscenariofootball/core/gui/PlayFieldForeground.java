...
public class PlayFieldForeground extends JPanel {
	...
	public PlayFieldForeground() {
		...
		try {
			ImageIO.read( PlayFieldBackground.class.getResource( "/mrscenariofootball/core/gui/grass.jpg" ));
			mBallImage = ImageIO.read( PlayFieldBackground.class.getResource( "/mrscenariofootball/core/gui/ball.png" ));
			mBlueBotImage = ImageIO.read( PlayFieldBackground.class.getResource( "/mrscenariofootball/core/gui/playerblue.gif" ));
			mYellowBotImage = ImageIO.read( PlayFieldBackground.class.getResource( "/mrscenariofootball/core/gui/playeryellow.gif" ));
			mNoneBotImage = ImageIO.read( PlayFieldBackground.class.getResource( "/mrscenariofootball/core/gui/playernone.gif" ));
		} catch (IOException e) {
			e.printStackTrace();
		}
